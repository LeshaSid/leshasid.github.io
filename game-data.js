...
const marketingGameData = {
  ...
  marketingActions: [
    // Увеличены baseCost для повышения сложности
    // Снижены baseValue для уменьшения отдачи
    { id: 1, name: "Платная реклама", baseCost: 90, keywords: ["таргет", "охват", "быстрый"], effect: "followers", baseValue: 20, type: "digital", effectDescription: "👥 Подписчики" },
    ...
    { id: 3, name: "Бартер с блогерами", baseCost: 110, keywords: ["блогер", "молодежь", "доверие", "вирус"], effect: "followers", baseValue: 30, type: "digital", communicable: true, effectDescription: "👥 Подписчики" },
    { id: 4, name: "Вирусный ролик", baseCost: 120, keywords: ["вирус", "хайп", "креатив", "массов"], effect: "both", baseValue: 35, type: "digital", creative: true, effectDescription: "📈 Репутация + 👥 Подписчики" },
    ...
    { id: 8, name: "Реклама на радио", baseCost: 120, keywords: ["местн", "эмоц", "охват"], effect: "reputation", baseValue: 25, type: "atl", effectDescription: "⭐ Репутация" },
    ...
    { id: 10, name: "Коллаборация", baseCost: 150, keywords: ["инфлюенсер", "хайп", "престиж", "расширение"], effect: "both", baseValue: 45, type: "digital", communicable: true, effectDescription: "📈 Репутация + 👥 Подписчики" },
    { id: 11, name: "PR-кампания", baseCost: 170, keywords: ["имидж", "престиж", "репутация", "долгосрочный"], effect: "reputation", baseValue: 50, type: "atl", communicable: true, effectDescription: "⭐ Репутация" },
    { id: 12, name: "Анализ рынка", baseCost: 120, keywords: ["аналитика", "стратегия", "рынок", "эффективность"], effect: "knowledge", baseValue: 1, type: "digital", analytical: true, effectDescription: "📚 Знание рынка" }
  ],
  clients: [
    { 
      id: 1, 
    ...
    { 
      ...
      satisfaction: 50,
      payment: 4000 // Снижен платеж
    }
  ],
  events: [
    // Увеличены негативные эффекты, снижены позитивные
    { type: "inflation", text: "Рыночные колебания! Инфляция немного подросла.", effect: "inflation", value: 0.08, severity: "medium" }, // Инфляция влияет на стоимость действий, увеличено значение
    { type: "boom", text: "Бум в отрасли! Вы получили грант.", effect: "budget", value: 200, severity: "low" }, // Снижен бонус
    { type: "crisis", text: "Кризис в медиа! Репутация немного пострадала.", effect: "reputation", value: -70, severity: "high" }, // Увеличен штраф
    { type: "viral", text: "Ваш старый проект внезапно стал вирусным!", effect: "followers", value: 70, severity: "low" }, // Снижен бонус
    ...
    { type: "scandal", text: "Скандал с конкурентами! Ваша репутация под угрозой.", effect: "reputation", value: -90, severity: "high" }, // Увеличен штраф
    { type: "investment", text: "Привлечены новые инвестиции! Бюджет пополнен.", effect: "budget", value: 350, severity: "medium" } // Снижен бонус
  ],
  officeLevels: [
    { level: 1, name: "Гараж", description: "Начало пути. +$15 в день.", cost: 0 }, // Снижен пассивный доход
    { level: 2, name: "Коворкинг", description: "Уже лучше. +$40 в день.", cost: 850 }, // Снижен пассивный доход, увеличена стоимость
    { level: 3, name: "Свой Офис", description: "Собственное пространство! +$80 в день.", cost: 2200 } // Снижен пассивный доход, увеличена стоимость
  ],
  careerLevels: [
    { level: 1, name: "Фрилансер", incomeMultiplier: 1.05, requirements: { reputation: 0, followers: 0 } }, // Снижен множитель дохода
    { level: 2, name: "Менеджер", incomeMultiplier: 1.25, requirements: { reputation: 90, followers: 350 } }, // Requirements slightly increased, multiplier decreased
    { level: 3, name: "Владелец агентства", incomeMultiplier: 1.6, requirements: { reputation: 140, followers: 750 } } // Requirements slightly increased, multiplier decreased
  ],
  talentTree: {
    digital: [
